...
class RandTreeADInfector(Infector):
	def __init__(self, max_infection, degrees_rv):
		super(RandTreeADInfector, self).__init__()
...
class RandTreePAADInfector(Infector):
	def __init__(self, source, max_infection, max_time, degrees_rv, num_hops_pa = 1):
		super(RandTreePAADInfector, self).__init__()
